...
const AUTHORS = [
  ...
  },
  {
    id: '2',
    name: 'Jax Thorne',
    image: 'https://picsum.photos/seed/jax/400/400',
          ...
          {AUTHORS.map((author, idx) => (
            ...
            >
              ...
              <div className="flex flex-col justify-center text-center md:text-left">
                ...
                <div className="mt-6">
                  <Link to="/catalog" className="inline-flex items-center gap-2 font-ui text-xs text-text-primary hover:text-starforge-gold transition-colors uppercase tracking-wider">
