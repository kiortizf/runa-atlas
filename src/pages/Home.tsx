...
const FEATURED_BOOKS = [
  {
    ...
    author: 'Elara Vance',
    cover: 'https://picsum.photos/seed/obsidian/600/900',
    codemark: '🗡️ Epic Fantasy',
    synopsis: 'In a world where magic is drawn from the marrow of fallen gods, a young thief discovers she carries the bloodline of the architects.',
  ...
  },
  {
    ...
    title: 'Neon Requiem',
    author: 'Jax Thorne',
    cover: 'https://picsum.photos/seed/neon/600/900',
    codemark: '🔥 Dystopian',
    synopsis: 'A cybernetic detective must solve the murder of an AI consciousness before the city\'s power grid is permanently severed.',
    editionType: 'Standard'
  },
  {
    id: '3',
    ...
    author: 'Marina Solis',
    cover: 'https://picsum.photos/seed/whispers/600/900',
    codemark: '🌊 Literary Fiction',
    synopsis: 'An exploration of grief and memory set against the backdrop of a sinking coastal town where the dead refuse to stay buried.',
    editionType: 'Signed'
  },
  {
    id: '4',
    ...
    author: 'Leo Vance',
    cover: 'https://picsum.photos/seed/circuits/600/900',
    codemark: '💜 Queer Romance',
    synopsis: 'Two rival mechanics on a deep-space mining colony find themselves forced to cooperate when their station is sabotaged.',
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="font-heading text-xl md:text-2xl text-text-secondary max-w-3xl mx-auto mb-12 italic">
              A celestial forge transmuting narratives into constellations. We champion marginalized voices in speculative fiction, fantasy, and beyond.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 font-ui">
              ...
              <Link to="/submissions" className="group px-8 py-4 border border-starforge-gold/50 text-starforge-gold rounded-sm font-semibold tracking-wide hover:bg-starforge-gold/10 transition-all w-full sm:w-auto flex items-center justify-center gap-2">
                Submit Your Story <PenTool className="w-4 h-4" />
              </Link>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="space-y-6 font-body text-lg text-text-secondary leading-relaxed">
                ...
                <p>
                  Our Starforge process is collaborative, transparent, and fiercely protective of our authors' visions. We don't just acquire books—we welcome creators into a living Runeweave, a collective constellation where every star shines brighter together.
                </p>
              </div>
